export const en = {
  ...
  info: {
    ...
    workPoolInfrastructureConfigurationAgent: 'Nebula Agents handle infrastructure configuration via infrastructure blocks attached to deployments. You can hit **Create** to create this work pool and then head over to the **Blocks** tab to create an infrastructure block for your deployments.\nTo learn more about how to configure infrastructure for Nebula Agents, check out the [docs](https://docs.nebula.io/latest/concepts/infrastructure/).',
